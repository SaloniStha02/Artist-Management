   ...
   <div class="min-h-screen bg-gray-100 flex flex-col">
    ...
    <div class="flex flex-col md:flex-row items-center justify-around">
      <form class="bg-white border-2 border-lightblue w-6/12 h-4/5 mt-8 px-10 py-8 text-left shadow-md rounded-lg" @submit.prevent="addUser">
        ...
        <div>
          <label class="block text-lg font-medium text-black mb-1">User Type:</label>
          <select name="user_type" id="user_type" class="shadow-md w-full h-10 px-5 py-2 border-2 border-blue rounded-lg text-lg mb-5" v-model="user.user_type" required>
